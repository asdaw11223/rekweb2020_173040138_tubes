    ...
    <div class="container">
        <div class="row mt-5 justify-content-center">
            ...
            <div class="col-md-6 mt-5">
                ...
                <h3 class="detail-pro"><?= $product['nama_brand']; ?> <?= $product['type']; ?></h3>

                <p class="detail-pro">
                    <b>Harga :</b> Rp. <?= number_format($product['price'], 0, 0, '.'); ?>,-
                </p>
                <p class="detail-pro">
                    <b>Operating System :</b> <?= $product['os']; ?>
                </p>
                <p class="detail-pro">
                    <b>CPU :</b> <?= $product['cpu']; ?>
                </p>
                ...
                <a href="/cart/beli/<?= $product['id']; ?>" class="card-product btn btn-dark mt-3">
                    <h5>+ Keranjang</h5>
                </a>
                </ul>
            </div>
